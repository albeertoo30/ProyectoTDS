...
public class TestVentanasAndrey extends Application {
    ...
    public void start(Stage stage) throws Exception {
    	...
    	FXMLLoader loader = new FXMLLoader(
    	    getClass().getResource("/umu/tds/gestion_gastos/notificacion/VentanaNotificacion.fxml")
    	);
    	Parent root = loader.load();

    	// Inyectar controlador de aplicación
    	ControladorVentanaNotificacion viewController = loader.getController();
    	...
    	stage.setOnCloseRequest(event -> {
    	    try {
    	        appController.guardarNotificaciones();
    	        System.out.println("Se han guardado correctamente los cambios");
    	    } catch (IOException e) {
    	        e.printStackTrace();
